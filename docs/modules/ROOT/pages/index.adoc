...
The core extension provides one built-in flag evaluator - `io.quarkiverse.flags.TimeSpanFlagEvaluator`.
It evaluates a flag based on the current date-time obtained from the system clock in the default time-zone.
